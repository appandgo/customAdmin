class NavHeaderController {
  constructor ($rootScope, ContextService) {
    ...
    ContextService.me(function (data) {
      ...
      // if(data) navHeader.userData.avatar =  !angular.isUndefined(data.avatar) ? data.avatar : "//placeholdit.imgix.net/~text?txtfont=monospace,bold&bg=DD4B39&txtclr=ffffff&txt=A&w=90&h=90&txtsize=36";
    })
